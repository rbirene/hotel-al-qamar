...
session_start();
	...
	//$sql = "INSERT INTO test2_tblBookingRequestDetails (DBgID, DBrID, DBbCheckIn, DBbNightsNo, DBbAdultNo, DBbChildrenNo, DBbRequest, DBbTotalPrice)
	//VALUES ('$DBgID', '$DBrID', '$bCheckIn', '$bNightsNo', '$bAdultNo', '$bChildrenNo', '$bRequest', '$bTotalPrice')";
	
	$sql = "INSERT INTO test2_tblBookingRequestDetails (DBgID, DBrID, DBbCheckIn, DBbNightsNo, DBbAdultNo, DBbTotalPrice) VALUES ('1', '1', '2018-04-11', '3', '1', '100')";
	...
	if (mysqli_query($conn, $sql)) { //if connection and record creation is successful...
		header ("Location: makeBooking_3.php");
	} else { //otherwise...
		header ("Location: makeBooking_2_error.php");
	}
