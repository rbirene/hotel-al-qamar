...
session_start();
	...
	$sql = "INSERT INTO test2_tblBookingRequestDetails (DBgID, DBrID, DBbCheckIn, DBbNightsNo, DBbAdultNo, DBbTotalPrice) VALUES ('$DBgID', '$DBrID', '$bCheckIn', '$bNightsNo', '$bAdultNo', '$bTotalPrice')";
