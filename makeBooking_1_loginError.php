      ...
      <div class="container">
        <div class="row d-flex justify-content-between align-items-center">
          ...
          <div class="col-6 text-center">
            <h2>Login Error</h2>
            <p class="error">There was an error with logging you in. Please try again.</p>
            ...
            <hr>
            <p>New here?<span class="gold"><a href="makeBooking_1_register.php">Register now.</a></span></p>
          </div>
        </div>
      </div>
    </section>
