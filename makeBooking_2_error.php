...
<html lang="en-GB">
  ...
  Page Name: Confirm
	...
	Description: Page for booking error.
  ...
  <body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
	  ...
	  //...if rRoomType field is left empty then display error message...
      if (empty($_POST["rRoomType"])){
        $rRoomTypeError = "*please select a room";
      }
      //...otherwise the rRoomType is as entered.
      else{
        $rRoomType = $_POST["rRoomType"];
      }
      ...
      <div class="container">
        <div class="row d-flex justify-content-between align-items-center">
          <div class="col-7 text-center">
            <h2>Booking Error</h2>
			<p class="error">There was an error with the booking. Please try again.</p>
            <form method="post" action="DB_insertToTable_booking.php">
              <div class="form-row">
                <div class="col-6">
				...
				<div class="col-6">
				  ...
				  <select class="form-control" name="bRoomType">
					  ...
					  <option>Standard Quad</option>
					  <option>Deluxe Single</option>
					  <option>Deluxe Double</option>
					  <option>Deluxe Triple</option>
					  <option>Deluxe Quad</option>
					</select>
